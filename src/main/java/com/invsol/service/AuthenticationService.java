...
public class AuthenticationService {
	...
	public Response authenticateBusinessUser(InputStream incomingData) throws AppException {
		...
		try {
			...
			BusinessUser businessUserData = authenticateUser.authenticateBusinessUser(userData.getLong(AppConstants.JSON_PHONENUMBER), userData.getString(AppConstants.JSON_PASSWORD));
